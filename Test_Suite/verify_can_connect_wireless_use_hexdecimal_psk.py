...
class VerifyHexcimalPSK(CaseFlowControl):
    ap_name = "R1-Linux-disconnect"
    password = "02751ea47f2f0517116e69b512461015cf2c37ee0f910023e4d4633c6ce92405"
    ...
    def set_wireless(self):
        ...
        wpa2_psk_hex = self.network.wpa2_psk_hex
        wpa2_psk_hex.global_unselected_checkbox.click()
...
def start(case_name, **kwargs):
    v = VerifyHexcimalPSK(script_name=VerifyHexcimalPSK.__name__, case_name=case_name)
    v.start()
