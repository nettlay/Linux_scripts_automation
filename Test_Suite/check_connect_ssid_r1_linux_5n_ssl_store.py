# case name: check connectivity with the SSID R1-Linux-5N use SSL Store tab certificate
# Author: nick.lu
...
class CheckSSIDR1Linux5NSSLStore(CaseFlowControl):
    ap_name = "R1-Linux-5N"
    username = r"sh\autotest1"
...
def start(case_name, **kwargs):
    v = CheckSSIDR1Linux5NSSLStore(script_name=CheckSSIDR1Linux5NSSLStore.__name__, case_name=case_name)
    v.start()
