# case name: check connectivity with the SSID R1-TC-5G_ax_WPA2P by Systray Icon
# Author: nick.lu
import time
...
class CheckR1TC5GaxWPA2PBySystray(CaseFlowControl):
    ...
    def set_wireless(self):
        ...
        disconnected_wireless.click()
        self.network.R1TC5GaxWPA2P.click()
        time.sleep(5)
...
def start(case_name, **kwargs):
    v = CheckR1TC5GaxWPA2PBySystray(script_name=CheckR1TC5GaxWPA2PBySystray.__name__, case_name=case_name)
    v.start()
