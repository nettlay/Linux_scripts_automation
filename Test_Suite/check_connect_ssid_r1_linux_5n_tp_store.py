...
class CheckSSIDR1Linux5NTPStore(CaseFlowControl):
    ap_name = "R1-Linux-5N"
    username = r"!#$%^"
    ...
    def set_wireless(self):
        ...
        self.network.wpa2_cert_rootca_crt.click()
...
def start(case_name, **kwargs):
    v = CheckSSIDR1Linux5NTPStore(script_name=CheckSSIDR1Linux5NTPStore.__name__, case_name=case_name)
    v.start()
