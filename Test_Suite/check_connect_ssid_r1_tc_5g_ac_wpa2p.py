...
class CheckSSIDR1Tc5gAcWpa2p(CaseFlowControl):
    ap_name = "R1-TC_5G_ac_WPA2P"
...
def start(case_name, **kwargs):
    v = CheckSSIDR1Tc5gAcWpa2p(script_name=CheckSSIDR1Tc5gAcWpa2p.__name__, case_name=case_name)
    v.start()
